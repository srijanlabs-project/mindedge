  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-200">
      ...
      <div className="bg-white rounded-2xl p-6 md:p-8 border border-slate-200/80 shadow-xs">
        ...
        <h2 className="text-xl font-bold text-slate-900 mt-3 tracking-tight">Find Licensed Sports Mental Coaches</h2>
        <p className="text-xs text-slate-500 mt-1 leading-relaxed">
          Connect with certified cognitive coaches experienced in teenage sports pressure, performance focus maps, and injury recovery therapy.
        </p>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-4 gap-4 bg-slate-50 p-4 rounded-xl border border-slate-200/60 font-sans">
          <div className="relative md:col-span-2">
            ...
            <input
              type="text"
              placeholder="Search therapist name, qualifications, clinical specialities..."
              value={searchTerm}
      ...
      {filteredTherapists.length === 0 ? (
        <div className="py-12 bg-white rounded-3xl border border-dashed border-gray-200 text-center text-gray-400 stroke-1 p-6 font-sans">
          ...
          <h3 className="text-md font-bold text-gray-900 mt-4">No Matching Sports Mental Coaches Found</h3>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="flex items-center gap-1">
                      ...
                      <ShieldCheck className="w-3.5 h-3.5 text-emerald-500 shrink-0" title="Mindedge Certified" />
                    </div>
